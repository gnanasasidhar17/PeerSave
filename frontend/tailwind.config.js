...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Dark theme primary colors - Electric Blue/Purple gradient
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
      ...
      backgroundImage: {
        ...
        'gradient-accent': 'linear-gradient(135deg, #a855f7 0%, #f093fb 100%)',
        'gradient-success': 'linear-gradient(135deg, #10b981 0%, #34d399 100%)',
        'gradient-warning': 'linear-gradient(135deg, #f59e0b 0%, #fbbf24 100%)',
        'gradient-danger': 'linear-gradient(135deg, #f43f5e 0%, #fb7185 100%)',
        'gradient-dark': 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)',
        'gradient-mesh': 'linear-gradient(135deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #a855f7 75%, #667eea 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
